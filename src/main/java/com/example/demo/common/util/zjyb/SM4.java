...
public class SM4
{
    ...
    public void sm4_setkey_enc(com.example.demo.common.util.zjyb.SM4_Context ctx, byte[] key) throws Exception
    {
        if (ctx == null)
        {
    ...
    public void sm4_setkey_dec(com.example.demo.common.util.zjyb.SM4_Context ctx, byte[] key) throws Exception
    {
        if (ctx == null)
        {
            throw new Exception("ctx is null!");
    ...
    public byte[] sm4_crypt_ecb(com.example.demo.common.util.zjyb.SM4_Context ctx, byte[] input) throws Exception
    {
        if (input == null)
        {
    ...
    public byte[] sm4_crypt_cbc(com.example.demo.common.util.zjyb.SM4_Context ctx, byte[] iv, byte[] input) throws Exception
    {
